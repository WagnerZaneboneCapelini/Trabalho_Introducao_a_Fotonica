...
ENV VIRTUAL_ENV /opt/Trabalho_Introducao_a_Fotonica-env
ENV PATH $VIRTUAL_ENV/bin:$PATH
RUN python -m venv $VIRTUAL_ENV

# Set the working directory.
WORKDIR /workspaces/Trabalho_Introducao_a_Fotonica/
...
COPY --chown=user:user poetry.lock* pyproject.toml /workspaces/Trabalho_Introducao_a_Fotonica/
RUN mkdir -p /home/user/.cache/pypoetry/ && mkdir -p /home/user/.config/pypoetry/ && \
    mkdir -p src/trabalho_introducao_a_fotonica/ && touch src/trabalho_introducao_a_fotonica/__init__.py && touch README.md
...
COPY --chown=user:user .pre-commit-config.yaml /workspaces/Trabalho_Introducao_a_Fotonica/
