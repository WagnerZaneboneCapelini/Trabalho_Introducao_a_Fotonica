...
Awesome trabalho_introducao_a_fotonica created by WagnerZaneboneCapelini
...
```sh
poetry add Trabalho_Introducao_a_Fotonica
```

```sh
pip install Trabalho_Introducao_a_Fotonica
```
